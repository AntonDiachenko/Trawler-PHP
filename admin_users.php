    ...
    <div class="container body-outer-container">
        ...
        <div class="row">
            <div class="col home-thumbnail">
                <a href="user.php?usertype=admin">
                    <img class="img-fluid img-thumbnail" src="img/admin_user.jpg" >
                </a>
                <input type="hidden" name = "usertype" value="admin">
                <h2>Admin Users</h2>
            </div>
            <div class="col home-thumbnail">
            <a href="user.php?usertype=user">
                    <img class="img-fluid img-thumbnail" src="img/customer_user.jpg">
                </a>
